...
본 시스템은 3개의 독립적인 하드웨어 노드(`aicar(지포스4070 외장그래픽)`, `bn(내장그래픽)`, `piaic(라즈베리파이3 1GB)`) 환경에서 분산 구동됩니다. (AI_Voice_Drone_Project 폴더 안의 각 폴더들을 다시 한번 확인하세요.)
데이터 스트림의 종속성에 따라 아래의 순서대로 시스템을 기동해야 합니다. (내장 그래픽카드와 외장 그래픽카드의 컴퓨터 사양은 인텔 i7-7700에 RAM 16GB(DDR4)입니다.)
...
* 이상 자세한 내용은 docs 폴더에서 확인하시길 바랍니다.
